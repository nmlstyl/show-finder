...
const BandsintownArtists = (props) => {
    ...
    function displayBandsintownArtists(){
      return props.bandsintownArtists.map((artist, idx) => <BandsintownArtist name={ artist.name } eventCount={ artist.eventCount } getBandsintownShows={ props.getBandsintownShows } key={ idx }/>)
    }
